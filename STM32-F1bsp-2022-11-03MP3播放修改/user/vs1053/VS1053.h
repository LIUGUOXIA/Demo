...
}Music_BitOffset_Enum;



typedef void(*pMusiHdlcFun)();

typedef struct
{
	Song_Type_Enum SongType_Name;
	Music_ByteID_Enum  Music_ByteID;
	Music_BitOffset_Enum Music_BitOffset;
	pMusiHdlcFun  pMusicHandleFunction;
...
void initmemory();
void Music_Select(Song_Type_Enum musicType, uint8_t status);
